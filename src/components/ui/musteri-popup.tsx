    ...
    >
      ...
      >
        <header className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
          ...
          <Button type="button" variant="ghost" size="icon" onClick={onClose} aria-label="Pencereyi kapat">
            <X />
          </Button>
        </header>
        ...
        <div className="flex items-center gap-2 border-b border-slate-200 px-5 py-2">
          ...
          <Button type="button" onClick={() => void ara()} className="bg-[#0047b3] text-white hover:bg-[#00398f]">
          ...
          <div className="grid min-h-[560px] gap-4 grid-rows-[minmax(250px,1fr)_minmax(220px,0.8fr)]">
            ...
            <section className="min-h-0 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
              <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
                ...
                {secilenMusteri && <span className="text-xs text-slate-500">{secilenMusteri.sube.kod} - {secilenMusteri.sube.ad}</span>}
              </div>
        ...
        {hata && <p className="border-t border-red-100 bg-red-50 px-5 py-2 text-sm font-medium text-red-700">{hata}</p>}
